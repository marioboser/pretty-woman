...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/pretty-woman)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/pretty-woman
```

A live public deployment of this template is available at [https://pretty-woman.templates.workers.dev](https://pretty-woman.templates.workers.dev)
